...
## PUDAL-Loop Orchestrator: dari Sinyal → Keputusan → Aksi → Pembelajaran {.unnumbered .unlisted}


### 1) Masalah yang ingin dipecahkan inovasi {.unnumbered .unlisted}
...
### 2) Inti inovasi: PUDAL-Loop Orchestrator {.unnumbered .unlisted}
...
### 3) Modul sistem (lebih “engineering”, bukan esai) {.unnumbered .unlisted}
#### (A) Evidence Collector (Offline-First) {.unnumbered .unlisted}
...
#### (B) Situation Classifier (AI + Rules) {.unnumbered .unlisted}
...
#### (C) Decision & Dispatch Engine (Playbook Aksi) {.unnumbered .unlisted}
...
#### (D) Ticketing + SLA + Public Status {.unnumbered .unlisted}
Status standar:
- received → triaged → assigned → in progress → verified → closed  
Bukti penutupan:
- foto/tes ulang + konfirmasi warga.

#### (E) Learning Layer {.unnumbered .unlisted}
...
### 4) Trade-off inovasi (biar terlihat matang) {.unnumbered .unlisted}
...
### 5) Artefak yang disarankan untuk repo {.unnumbered .unlisted}
...
## Lampiran: Tabel Playbook (contoh awal) {.unnumbered .unlisted}
