...
{\centering \includegraphics[width=6.25in,height=\textheight,keepaspectratio]{images/IMG_9791.JPG}
...
\chapter{Identifikasi}\label{identifikasi}
...
\chapter{Tinjauan Umum}\label{tinjauan-umum}
...
\chapter{Tinjauan Spesifik}\label{tinjauan-spesifik}

\section{UTS-1: All About Me}\label{uts-1-all-about-me}
...
\section{UTS-2: Songs for You (``Halfway Home
...
\section{UTS-3: My Stories for You (``Jejak Waktu dan
...
\section{UTS-4: My SHAPE}\label{uts-4-my-shape}
...
\section{UTS-5: My Personal Review}\label{uts-5-my-personal-review}
...
\chapter{Rekap Skor dan Kontribusi
...
\textbf{Total rerata keseluruhan: 87.4\% (setara A--)}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\bookmarksetup{startatroot}

\chapter{Kesimpulan}\label{kesimpulan}
